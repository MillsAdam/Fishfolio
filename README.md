...
Fishfolio is a robust platform designed for a client managing multiple fish hatcheries. It enables inventory management and monitoring of fish statistics over time, utilizing a full-stack approach with Vue.js, Java, and PostgreSQL, hosted on Heroku and Netlify.

## Project Setup

This project is structured with a clear separation between client and server, ensuring smooth development and deployment processes.
